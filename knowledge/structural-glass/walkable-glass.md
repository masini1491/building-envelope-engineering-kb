...
1. laminated make-up
2. effective stiffness / load duration
3. dead load
4. live load / concentrated load（依 governing code / project requirement）
5. support geometry
6. bending / deflection
7. local support / edge / hole stress
8. slip resistance / surface treatment（若屬專案要求）
...
> 實際 walkable glass 設計還應服從所在地 building code、guard / barrier / accessibility 與專案使用條件。