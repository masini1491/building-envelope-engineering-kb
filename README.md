...
以**台灣帷幕牆與建築外殼工程實務**為核心的公開技術知識庫，主要面向台灣帷幕牆工程專業營造業及相關從業人員，供工程師與 AI（例如 ChatGPT、Codex、Claude Code、Gemini CLI、GitHub Copilot）查詢、交叉驗證、計算審查與持續維護。
...
本知識庫最初以**台灣帷幕牆工程專業營造業及相關建築外殼工程從業人員**的實務需求為主要使用情境，尤其著重帷幕牆系統設計、細部設計、施工圖與材料送審、結構與性能審查、試驗、施工介面協調、品質管理及工程問題查核。

預期使用者包括帷幕牆工程公司的設計、工程、工務、品管與技術管理人員，以及與帷幕牆工程協作的建築師、結構技師、顧問、營造廠、材料與系統供應商、試驗單位及其他建築外殼相關專業人員。

內容以**台灣工程環境與實務**為核心，優先整理台灣法規、CNS，以及台灣帷幕牆工程常引用的 ASTM、AAMA-FGIA、ISO 等標準與工程方法；涉及特定專案時，仍應以該專案契約、設計條件、核定文件及適用法規為準。

本知識庫的目的不是取代專業判斷，而是讓從業人員與 AI 更快完成**查資料、核對依據、找出缺口、審查計算與規範、整理工程知識，以及降低重複查找成本**。
